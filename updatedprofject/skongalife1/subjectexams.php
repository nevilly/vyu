			...
			<div class = 'section'>
		      <?php include 'include/profileheader.php'; ?>
				...
				<header id = header_lect>
					<div id ='topic_to_cover'>2016-2011</div>
					<div id ='Subject_Lectures'>2010-2006</div>
					<div id ='Teachers_Help'>2007-2002</div>
					<div id ='Lectures_PlayList'>2001 - 1996 </div>
				</header>
				...
				<div class = 'Myfucults'>
					...
					<div id = 'subjectTeacher'>
						<div class ='t_profile'><embed src ='pdfile/biosExams/p2.png' width ='100px' height ='100px;'></div>
						<div class ='details'>
