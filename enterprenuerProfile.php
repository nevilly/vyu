			    ...
			    <div id = 'Stictix'>
			        ...
			        <div class = "tenderTime">
	                    ...
	                    <div class = "tenderWraper">
	                    	<div class = "divMalaya">
                                <div class = "headerTop">
                                	<div class = "profela">
										...
										<div class = "details">
											<span class = "profName">Nehemia Mwansasu</span>
											<span class = "profStatus">EnterprenuerShip</span>
										</div>
										
										<h3>TENDA YA MPUNGA MAGUNIA 100</h3>
										
                                        
										<div class = "datpisted">23/9</div>
                                	</div>
                                </div>
                                <div class = "AdvOnTenders">
                                	
                                	adv of shamba la kudoshwa
                                </div>
                                <section>
                                    <header></header>
                                	<div class ="wraperMalaya">
                                		Mpunga wa kilombelo<br/>
                                		Umevunwa tarehe 2/2/2014<br/>

                                		unapatkana maeno ya buguruni <br/>
                                        dadline ya mauzo ni j3
                                	</div>
                                	<div class = "footerMalayaer">
                                		<div class = "seemor">See More...</div>
                                		
                                		<div class = "invitebotton">
                                		Eccept Offer
	                    	...
	                    	<div class = "bageabPrice">
	                    		    <h3>BAGAIN HERE</h3>
                                	<span class ="negotativePrice"><input type = "text" placeholder="Eg:0654881994"></span>
                                	<span class ="negotativePrice"><input type = "text" placeholder="Enter ur Price">Tzs</span>
                                	<div class = "sendButon">Beggein</div>
                            </div>

                            
                            <div class = "headerTop tenderOffered">
                                <div class = "profela">
	                        		<div class = 'profImg'>
										<img src ='img/profiles/p4.jpg' >
									</div>
									...
									<div class = "details">
										<span class = "profName">Lugano Mwakasungura</span>
										<span class = "profStatus">Teacher</span>
									</div>
									
									<h3 class = 'priceHeader'>
										<span class = "title">MY PRICE</span>
										<span class = "pricetendered">3,000,000</span>
									</h3>
									
									<div class = "datpisted">23/9</div>
									<div class = "tenderreplisbotton">
										<div class = "clickbotton">Eccept</div>
										<div class = "clickbotton" onclick = "openAbsolute('chartplace');">reply</div>
									</div>
                        	    </div>
                            </div>

                            <div id = "chartplace" class = "chartplace">
                                <div class = "xoverflow">
                            	    <div class = "chart">
	                            	    <div class = "profela">
			                        		<div class = 'profImg'>
											...
											<div class = "details">
												<span class = "profName">Lugano Mwansasu</span>
												<span class = "profStatus">Teacher</span>
											</div>
										</div>  
	                        	        ...
	                        	        <div class = "mainChart">
	                        	            <div class = "mainbody">
	                        	        	Npunguzie kdogo ili tufanye biashara nitaitaji mizgo ming sana
	                        	        	</div>
	                        	        	<div class = "div">
	                        	        	<div class = "datpisted">23/9</div>
	                        	        	<div class = "reply"><i>reply</i>></div>
                        	    ...
                        	    <div class = "chartplac"><input type = "text" class= "posther" placeholder="type here"></div>
                            </div>
