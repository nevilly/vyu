    ...
    <div id = 'side_two' >
		...
		<div id='mainWraper'>
			<div class = 'section'>
				...
				<h2 class = "worrldWraper">SCIENCE WORD</h2>
                <?php $frompage = 2; //science page ?>
		    ...
		    <div class = 'infoSection'>
				...
				<div id ='newst' class = 'info_memba subjectMemba'>
				    <h3 class = "">SCIENCE PHOTOS</h3>
					<div class ='membasubject SciencPhoto' onclick = "">
                            ...
                            <div class ="membaD">
								<div class = "tpcName">Irrigation</div>
								<div class = "subject">Bone Structure</div>
							</div>
					</div>
				...
				<div id ='newst' class = 'info_memba subjectMemba'>
				    <h3 class = "">THEORY AND DEFINITION</h3>
